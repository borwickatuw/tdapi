...
if __name__ == "__main__":
    ...
    for ticket in TDTicket.objects.search(
        ...
        ticket.add_to_feed_and_notify_all(
            status_id=CLOSED, is_private=False, comments="Ticket closed"
        )
    ...
    for ticket in TDTicket.objects.search(
        ...
        ticket.add_to_feed_and_notify_all(
            status_id=STATUS_2, is_private=False, comments="Ticket progressing to Status 2"
        )
